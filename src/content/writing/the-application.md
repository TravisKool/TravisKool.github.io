...
anchors a series about building it with teams of coding agents. The index
lists them newest first, so here they are in the order they happened:

1. [Two teams picked up the same work](/writing/two-teams-one-work-item/) —
   the coordination failure, and the claim protocol that ended it.
2. [The pause](/writing/the-pause/) — reprioritizing around what gets clubs
   something useful soonest, and how it stays free for the pilots who need it.
3. [Guardrails I trust more than my own review](/writing/guardrails-over-review/)
   — the pillars, hooks, and coverage gate that took over from reading
   every diff.
4. [Running an engineering org from a phone](/writing/running-an-engineering-org-from-a-phone/)
   — six agents in containers, and the part of the org chart I still cannot see.
5. [The rebrand](/writing/the-rebrand/) — what happened when I commissioned a
   design review from an agent and it told me the truth.

The application is not yet public, so this describes it without naming it.
The moment there is something you can open and use, I will link it here.
...
Blazor Server earns its place on more than familiarity, though. The browser
gets HTML and a small connection script rather than a framework bundle, so
first paint is quick and there is no runtime to download before the page
works. One language spans the whole stack, which deletes the entire class of
bugs where a server model and a client model drift apart, and deletes the
hand-written API layer between them along with it. Every interaction is a
round trip the server renders and diffs, so the app can never ship logic to
the client that it did not mean to — which matters enormously for a record
where a landowner's name, a club's private register, and a gate code are all
one authorization check away from the page. Debugging is ordinary .NET
debugging, breakpoints and all, on both halves at once.

SQLite in particular — one file, no server — matches a record-keeping product
whose write rate is human-scale, and it keeps both production and every test
fixture honest by running the same engine.
...
<line x1="30" y1="165.66666666666666" x2="592" y2="165.66666666666666" stroke="var(--rule)" stroke-width="1"/><text x="24" y="168.66666666666666" font-family="var(--font-mono)" font-size="11" fill="var(--ink-faint)" text-anchor="end" style="font-variant-numeric: tabular-nums">50</text><line x1="30" y1="117.33333333333333" x2="592" y2="117.33333333333333" stroke="var(--rule)" stroke-width="1"/><text x="24" y="120.33333333333333" font-family="var(--font-mono)" font-size="11" fill="var(--ink-faint)" text-anchor="end" style="font-variant-numeric: tabular-nums">100</text><line x1="30" y1="69" x2="592" y2="69" stroke="var(--rule)" stroke-width="1"/><text x="24" y="72" font-family="var(--font-mono)" font-size="11" fill="var(--ink-faint)" text-anchor="end" style="font-variant-numeric: tabular-nums">150</text><line x1="30" y1="176.3" x2="592" y2="176.3" stroke="var(--ink-faint)" stroke-width="1" stroke-dasharray="4 4"/><text x="34" y="190.3" font-family="var(--font-mono)" font-size="11" letter-spacing="1.5" fill="var(--ink-muted)" text-anchor="start">ENTIRE 2025 ERA — 39</text><path d="M30 214 L30 213.16666666666666 Q30 209.16666666666666 34 209.16666666666666 L94.28571428571429 209.16666666666666 Q98.28571428571429 209.16666666666666 98.28571428571429 213.16666666666666 L98.28571428571429 214 Z" fill="var(--accent)"/><text x="64.14285714285714" y="203.16666666666666" font-family="var(--font-mono)" font-size="13" letter-spacing="1" fill="var(--ink)" text-anchor="middle" style="font-variant-numeric: tabular-nums">5</text><text x="64.14285714285714" y="230" font-family="var(--font-mono)" font-size="11" fill="var(--ink-faint)" text-anchor="middle" style="font-variant-numeric: tabular-nums">12</text><path d="M112.28571428571429 214 L112.28571428571429 214 Q112.28571428571429 212.06666666666666 114.21904761904763 212.06666666666666 L178.63809523809525 212.06666666666666 Q180.57142857142858 212.06666666666666 180.57142857142858 214 L180.57142857142858 214 Z" fill="var(--accent)"/><text x="146.42857142857144" y="206.06666666666666" font-family="var(--font-mono)" font-size="13" letter-spacing="1" fill="var(--ink)" text-anchor="middle" style="font-variant-numeric: tabular-nums">2</text><text x="146.42857142857144" y="230" font-family="var(--font-mono)" font-size="11" fill="var(--ink-faint)" text-anchor="middle" style="font-variant-numeric: tabular-nums">13</text><path d="M194.57142857142858 214 L194.57142857142858 212.2 Q194.57142857142858 208.2 198.57142857142858 208.2 L258.8571428571429 208.2 Q262.8571428571429 208.2 262.8571428571429 212.2 L262.8571428571429 214 Z" fill="var(--accent)"/><text x="228.71428571428572" y="202.2" font-family="var(--font-mono)" font-size="13" letter-spacing="1" fill="var(--ink)" text-anchor="middle" style="font-variant-numeric: tabular-nums">6</text><text x="228.71428571428572" y="230" font-family="var(--font-mono)" font-size="11" fill="var(--ink-faint)" text-anchor="middle" style="font-variant-numeric: tabular-nums">14</text><path d="M276.8571428571429 214 L276.8571428571429 210.26666666666668 Q276.8571428571429 206.26666666666668 280.8571428571429 206.26666666666668 L341.14285714285717 206.26666666666668 Q345.14285714285717 206.26666666666668 345.14285714285717 210.26666666666668 L345.14285714285717 214 Z" fill="var(--accent)"/><text x="311.00000000000006" y="200.26666666666668" font-family="var(--font-mono)" font-size="13" letter-spacing="1" fill="var(--ink)" text-anchor="middle" style="font-variant-numeric: tabular-nums">8</text><text x="311.00000000000006" y="230" font-family="var(--font-mono)" font-size="11" fill="var(--ink-faint)" text-anchor="middle" style="font-variant-numeric: tabular-nums">15</text><path d="M359.14285714285717 214 L359.14285714285717 180.3 Q359.14285714285717 176.3 363.14285714285717 176.3 L423.42857142857144 176.3 Q427.42857142857144 176.3 427.42857142857144 180.3 L427.42857142857144 214 Z" fill="var(--accent)"/><text x="393.28571428571433" y="170.3" font-family="var(--font-mono)" font-size="13" letter-spacing="1" fill="var(--ink)" text-anchor="middle" style="font-variant-numeric: tabular-nums">39</text><text x="393.28571428571433" y="230" font-family="var(--font-mono)" font-size="11" fill="var(--ink-faint)" text-anchor="middle" style="font-variant-numeric: tabular-nums">16</text><path d="M441.42857142857144 214 L441.42857142857144 58.5 Q441.42857142857144 54.5 445.42857142857144 54.5 L505.7142857142857 54.5 Q509.7142857142857 54.5 509.7142857142857 58.5 L509.7142857142857 214 Z" fill="var(--accent)"/><text x="475.5714285714286" y="48.5" font-family="var(--font-mono)" font-size="13" letter-spacing="1" fill="var(--ink)" text-anchor="middle" style="font-variant-numeric: tabular-nums">165</text><text x="475.5714285714286" y="230" font-family="var(--font-mono)" font-size="11" fill="var(--ink-faint)" text-anchor="middle" style="font-variant-numeric: tabular-nums">17</text><path d="M523.7142857142858 214 L523.7142857142858 201.56666666666666 Q523.7142857142858 197.56666666666666 527.7142857142858 197.56666666666666 L588.0000000000001 197.56666666666666 Q592.0000000000001 197.56666666666666 592.0000000000001 201.56666666666666 L592.0000000000001 214 Z" fill="var(--accent)"/><text x="557.8571428571429" y="191.56666666666666" font-family="var(--font-mono)" font-size="13" letter-spacing="1" fill="var(--ink)" text-anchor="middle" style="font-variant-numeric: tabular-nums">17</text><text x="557.8571428571429" y="230" font-family="var(--font-mono)" font-size="11" fill="var(--ink-faint)" text-anchor="middle" style="font-variant-numeric: tabular-nums">18</text><line x1="30" y1="214" x2="592" y2="214" stroke="var(--rule-strong)" stroke-width="1"/><text x="30" y="18" font-family="var(--font-mono)" font-size="11" letter-spacing="1.5" fill="var(--ink-muted)" text-anchor="start" style="font-variant-numeric: tabular-nums">COMMITS LANDED PER DAY — AUGUST 2026</text><text x="592" y="248" font-family="var(--font-mono)" font-size="11" letter-spacing="1.5" fill="var(--ink-muted)" text-anchor="end" style="font-variant-numeric: tabular-nums">AUG 12 – 18</text>
</svg>
...
It has taken about six and a half weeks of actual building to get here — five
and a half in late 2025, one this month, with eight and a half months of not
touching it in between. That gap matters to the answer: I did not grind at
this for a year, I made two runs at it with very different tools.

My honest reading after those two runs: the boundary moves, but it does not
